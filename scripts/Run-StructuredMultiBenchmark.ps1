...
$outputPath = New-BenchmarkOutputPath -Prefix "structured-multi"

Write-BenchmarkBanner -Title "Structured Benchmark - Multi Stack"
...
Write-Host "Structured multi benchmark results saved to $outputPath" -ForegroundColor Green
