...
$outputPath = New-BenchmarkOutputPath -Prefix "unstructured-single"

Write-BenchmarkBanner -Title "Unstructured Benchmark - Single Stack"
...
Write-Host "Unstructured single benchmark results saved to $outputPath" -ForegroundColor Green
